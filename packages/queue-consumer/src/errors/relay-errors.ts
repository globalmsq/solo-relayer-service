...
export const NON_RETRYABLE_ERROR_PATTERNS: ErrorPattern[] = [
  ...
  { pattern: /insufficient funds/i, description: 'Insufficient balance for transaction' },
  { pattern: /insufficient balance/i, description: 'Insufficient balance for transaction' },

  // Gas errors
  { pattern: /gas required exceeds allowance/i, description: 'Gas limit exceeded allowance' },
  { pattern: /intrinsic gas too low/i, description: 'Insufficient gas provided' },
  ...
  { pattern: /execution reverted/i, description: 'Smart contract execution reverted' },
  { pattern: /transaction would revert/i, description: 'Transaction simulation failed' },
];
...
export const RETRYABLE_ERROR_PATTERNS: ErrorPattern[] = [
  ...
  { pattern: /ECONNREFUSED/i, description: 'Connection refused (ECONNREFUSED)' },
 ...
 * - 504: Gateway Timeout
 */
export const RETRYABLE_HTTP_STATUS_CODES: number[] = [408, 429, 500, 502, 503, 504];
